...
const  { alchemyApiKey, mnemonics } = require('./secret.json');
...
module.exports = {
  networks: {
    ...
    rinkeby: {
      provider: () => new HDWalletProvider(mnemonics, `https://eth-rinkeby.alchemyapi.io/v2/${alchemyApiKey}`),
      network_id: 4,       // Ropsten's id
      // gas: 1e9,        // Ropsten has a lower block limit than mainnet
